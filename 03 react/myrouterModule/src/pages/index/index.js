...
class Indexpage extends React.Component {
  constructor(props) {
    ...
    this.num = props.state.counter.count;
  }
  ...
  increment() {
    ...
    */
    //{ type: "INC", data: { count: ++this.state.num } }

    let data = { count: ++this.num };
    this.props.dispatch(actions.counter.addCount(data));
  }
  ...
  decrement() {
    ...
    let data = { count: --this.num };
    this.props.dispatch(actions.counter.cutCount(data));
  }
  render() {
